...
* [FEATURE] Basic auth can now be configured via file across all configuration
* [ENHANCEMENT] Optimise PromQL for memory usage and allocations
* [ENHANCEMENT] Limit number of dropped targets in web UI
* [ENHANCEMENT] Add advanced filtering configuration to Consul service discovery
...
* [BUGFIX] Unary minus expressions now remove the metric name from results
